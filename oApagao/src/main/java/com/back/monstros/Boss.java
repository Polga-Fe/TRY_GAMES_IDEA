...
public class Boss extends Monstrx {
    ...
    public Boss(String imagePath, int frameWidth, int frameHeight, double speed, double startX, double startY) {
        super("boss", 100, 70, 70);
    ...
    public void draw(GraphicsContext gc) {
        ...
        WritableImage frame = spriteSheet.getFrameFromRow(0, currentFrame, 2, Color.TRANSPARENT);
        if (frame != null){
